...
<h1 style="text-align: center; font-family: 'Mansalva',cursive; font-weight: 300; font-size: 50px; margin-top: 50px; ">
...
<div
    ...
    <div>
        <div class="text-wrapper"
            style=" flex-wrap: wrap;  margin-top: 100px;  margin-bottom: -250px; width: 100%; height: 75vh; padding-top: 40px;">
            <h1
