...
function validate(event){
    ...
    // var passwordConfirmVal = document.getElementById('e4');
    // var birthdayVal = document.getElementById('e5');
    var nameError = false;
    var emailError = false;
    var passwordError = false;
    // var birthdayError = false;
    //valid
    // var nameG = document.getElementById('v1');
    // var emailG = document.getElementById('v2');
    // var PasswordG = document.getElementById('v3');
    // var PasswordConfirmG = document.getElementById('v4');
    // var birthdayG = document.getElementById('v5');
